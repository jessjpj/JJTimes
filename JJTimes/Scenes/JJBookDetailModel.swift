...
// MARK: - JJBookDetailModel
public struct JJBookDetailModel: Codable {
    let numResults: Int
    let results: JJBookDetailResults
...
// MARK: - JJBookDetailResults
struct JJBookDetailResults: Codable {
